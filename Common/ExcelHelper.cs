...
namespace Common
{
    ...
    public class ExcelHelper
    {
        ...
        public static ArrayList GetExcelTables(string ExcelFileName)
        {
            ...
            {
                using (OleDbConnection conn = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + ExcelFileName + ";Extended Properties='Excel 8.0;HDR=Yes;IMEX=1;'"))
                {
                    try
                    {
                        conn.Open();
        ...
        public static DataTable InputFromExcel(string ExcelFilePath, string TableName)
        {
            ...
            OleDbConnection dbcon = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + ExcelFilePath + ";Extended Properties='Excel 8.0;HDR=Yes;IMEX=1;'");
